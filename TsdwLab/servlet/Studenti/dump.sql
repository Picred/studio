...
CREATE TABLE `students` (
  ...
  `corso_di_laurea` int DEFAULT NULL,
  PRIMARY KEY (`matricola`),
  KEY `corso_di_laurea` (`corso_di_laurea`),
  CONSTRAINT `students_ibfk_1` FOREIGN KEY (`corso_di_laurea`) REFERENCES `courses` (`codice_corso`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students` VALUES (1,'Mario','Rossi',1),(2,'Luca','Bianchi',2),(3,'Anna','Verdi',3);
...
-- Dump completed on 2023-12-09 14:17:56