...
//         printf("\nErrore! Inserisci un numero di porta valido\n"); // Porta gia in uso
//         return -1;
//     }
...
//////////////Receiver pt.2 che ascolta all'infinito
...
//////////////////// Server riceve un msg. Lo stampa. Risponde al client come se fosse un ACK. Se il client scrive FINE, allora il server chiude la connessione con QUEL CLIENT MA rimane attivo perchè deve ascoltare eventuali altri client
